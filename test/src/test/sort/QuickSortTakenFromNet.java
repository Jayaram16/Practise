...
public class QuickSortTakenFromNet {
	...
	public static void main(String[] args) {
		...
		QuickSortTakenFromNet theSort = new QuickSortTakenFromNet(10);

		theSort.generateRandomArray();

		System.out.println(Arrays.toString(QuickSortTakenFromNet.theArray));
	...
	QuickSortTakenFromNet(int newArraySize) {
