...
static int counter=1;
	public static void main(String[] args) {
		...
		/*String avc = "Hi There Satish we are working on it";
		String a[] = avc.split(" ");
		for (int j = a.length-1; j >= 0; j--) {
			System.out.print(a[j]+" ");
		}*/
		/*Node cutNode=cutAndJoin(treeNode);
		System.out.println("Value after 1 st cutting is "+cutNode.val);
		Node cutNode2=cutAndJoin(cutNode);
		System.out.println("Value after 2nd cutting is "+cutNode2.val);
		Node cutNode3=cutAndJoin(cutNode2);
		System.out.println("Value after 2nd cutting is "+cutNode3.val);
		*/
